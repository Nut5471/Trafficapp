...
public class MainActivity extends AppCompatActivity {
    ...
    ListView listView;
    int[] ints = new int[]
            {R.drawable.traffic_01,R.drawable.traffic_02,R.drawable.traffic_03,R.drawable.traffic_04,R.drawable.traffic_05,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ผูกตัวแปน Java กัับ Xml
        listView = findViewById(R.id.livTraffic);

        //ดึงค่าจาก my_content มาเเสดงผลบนหน้า  xml
        ...
        //ทำการเชื่อมโยงเเต่ละรายการใน Lisview ให้ลิ้งไปหน้า Detail
